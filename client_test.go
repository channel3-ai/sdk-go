...
import (
	...
	"github.com/channel3-ai/sdk-go/internal"
...
func TestContextDeadlineStreaming(t *testing.T) {
	...
	go func() {
		...
		stream := client.Responses.NewStreaming(deadlineCtx, channel3go.ResponseNewParams{
			ChatRequest: channel3go.ChatRequestParam{},
		})
		for stream.Next() {
			_ = stream.Current()
		}

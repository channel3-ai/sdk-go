...
// RequestOption is an option for the requests made by the channel3 API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/public-sdk-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.trychannel3.com/")
}
...
// WithLanguage returns a RequestOption that sets the client setting "language".
func WithLanguage(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.Language = value
		return r.Apply(WithHeader("X-Channel3-Language", value))
	})
}

// WithCountry returns a RequestOption that sets the client setting "country".
func WithCountry(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.Country = value
		return r.Apply(WithHeader("X-Channel3-Country", value))
	})
}

// WithCurrency returns a RequestOption that sets the client setting "currency".
func WithCurrency(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.Currency = value

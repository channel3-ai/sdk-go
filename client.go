...
// interacting with the channel3 API. You should not instantiate this client
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("CHANNEL3_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("CHANNEL3_LANGUAGE"); ok {
		defaults = append(defaults, option.WithLanguage(o))
	}
	if o, ok := os.LookupEnv("CHANNEL3_COUNTRY"); ok {
		defaults = append(defaults, option.WithCountry(o))
	}

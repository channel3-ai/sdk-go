# Channel3 Go API Library

<!-- x-release-please-start-version -->

<a href="https://pkg.go.dev/github.com/channel3-ai/sdk-go"><img src="https://pkg.go.dev/badge/github.com/channel3-ai/sdk-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Channel3 Go library provides convenient access to the [Channel3 REST API](https://docs.trychannel3.com)
...
```go
import (
	"github.com/channel3-ai/sdk-go" // imported as channel3go
)
```
...
```sh
go get -u 'github.com/channel3-ai/sdk-go@v0.1.0'
```
...
client.Products.Search(context.TODO(), ...,
	// Override the header
...
See the [full list of request options](https://pkg.go.dev/github.com/channel3-ai/sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/channel3-ai/sdk-go/issues) with questions, bugs, or suggestions.

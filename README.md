...
<a href="https://pkg.go.dev/github.com/stainless-sdks/public-sdk-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/public-sdk-go.svg" alt="Go Reference"></a>
...
```sh
go get -u 'github.com/stainless-sdks/public-sdk-go@v0.0.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/public-sdk-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/public-sdk-go/issues) with questions, bugs, or suggestions.
